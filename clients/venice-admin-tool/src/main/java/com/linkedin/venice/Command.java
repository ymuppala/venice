...
public enum Command {
  ...
  UPDATE_STORE(
      ...
      new Arg[] { CLUSTER, OWNER, VERSION, LARGEST_USED_VERSION_NUMBER, LARGEST_USED_RT_VERSION_NUMBER, PARTITION_COUNT,
          ...
          BACKUP_STRATEGY, INGESTION_PAUSE_MODE, INGESTION_PAUSED_REGIONS, AUTO_SCHEMA_REGISTER_FOR_PUSHJOB_ENABLED,
          INCREMENTAL_PUSH_ENABLED, BOOTSTRAP_TO_ONLINE_TIMEOUT_IN_HOUR, HYBRID_STORE_DISK_QUOTA_ENABLED,
          REGULAR_VERSION_ETL_ENABLED, FUTURE_VERSION_ETL_ENABLED, ETLED_PROXY_USER_ACCOUNT, VENICE_ETL_STRATEGY,
          NATIVE_REPLICATION_ENABLED, PUSH_STREAM_SOURCE_ADDRESS, BACKUP_VERSION_RETENTION_DAY, REPLICATION_FACTOR,
          ...
          FLINK_VENICE_VIEWS_ENABLED, BLOB_DB_ENABLED }
  ),
